...
export const products: Product[] = [
  {
    ...
    rating: 4.5,
    reviewCount: 120,
    imageIds: ['product-sofa-1', 'product-sofa-2', 'product-sofa-3', 'product-sofa-4', 'product-sofa-7', 'product-sofa-9'],
  ...
  },
  {
    ...
    rating: 4.6,
    reviewCount: 28,
    imageIds: ['product-ashwin-sofa-1', 'product-ashwin-sofa-2', 'product-ashwin-sofa-3', 'product-ashwin-sofa-4', 'product-ashwin-sofa-5', 'product-ashwin-sofa-6', 'product-ashwin-sofa-7', 'product-ashwin-sofa-8'],
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 88,
    imageIds: ['product-chesterfield-sofa-1', 'product-chesterfield-sofa-2', 'product-chesterfield-sofa-3', 'product-chesterfield-sofa-4', 'product-chesterfield-sofa-5', 'product-chesterfield-sofa-6', 'product-chesterfield-sofa-7'],
  ...
  },
  {
    ...
    variants: [
      ...
      { size: 'Large Corner', price: 490.00, dimensions: { width: '245cm', depth: '220cm', height: '100cm' } },
    ],
    rating: 4.7,
    reviewCount: 42,
    imageIds: ['product-dino-sofa-1', 'product-dino-sofa-2', 'product-dino-sofa-3', 'product-dino-sofa-4', 'product-dino-sofa-5', 'product-dino-sofa-6', 'product-dino-sofa-7', 'product-dino-sofa-8', 'product-dino-sofa-9', 'product-dino-sofa-10'],
    ...
    dimensions: { width: '240cm', height: '85cm', depth: '105cm' }, // This will be the default/fallback dimension
    style: 'Contemporary',
    material: 'Fabric',
    stock: 15,
  },
  {
    ...
    variants: [
      ...
      { size: 'Corner Sofa', price: 450.00, dimensions: { width: '212cm', depth: '164cm', height: '78cm' } },
    ],
    rating: 4.8,
    reviewCount: 52,
    imageIds: ['product-dylan-sofa-1', 'product-dylan-sofa-2', 'product-dylan-sofa-3', 'product-dylan-sofa-4', 'product-dylan-sofa-5', 'product-dylan-sofa-6', 'product-dylan-sofa-7', 'product-dylan-sofa-8', 'product-dylan-sofa-9', 'product-dylan-sofa-10'],
    ...
    details: [
      'Luxurious blue velvet upholstery',
      'High-density foam cushions for superior comfort',
      'Slim track arms for a modern look',
      'Solid wood frame for durability',
      'Floor to seat height 47cm',
      'Depth of seat 49cm to front of pillows',
      'Seat back height 50cm',
      'Arm unit (W)123cm, (D)89cm, (H)78cm',
      'Chaise unit (W)164cm, (D)89cm, (H)78cm',
    ],
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 65,
    imageIds: ['product-electric-recliner-1', 'product-electric-recliner-2', 'product-electric-recliner-3'],
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 72,
    imageIds: ['product-harrison-sofa-1', 'product-harrison-sofa-2', 'product-harrison-sofa-3', 'product-harrison-sofa-4', 'product-harrison-sofa-6',],
  ...
  },
  {
    ...
    rating: 4.6,
    reviewCount: 38,
    imageIds: ['product-lilly-sofa-1', 'product-lilly-sofa-2', 'product-lilly-sofa-3'],
  ...
  },
  {
    ...
    variants: [
      ...
      { size: '3 Seater', price: 399.00, dimensions: { width: '198cm', depth: '90cm', height: '90cm' } },
      { size: '3+2 Seater', price: 670.00 },
      { size: '5 Seater Corner', price: 690.00, dimensions: { width: '230cm', depth: '230cm', height: '96cm' } },
    ],
    rating: 4.9,
    reviewCount: 75,
    imageIds: ['product-roma-recliner-1', 'product-roma-recliner-2', 'product-roma-recliner-3', 'product-roma-recliner-4', 'product-roma-recliner-5', 'product-roma-recliner-6', 'product-roma-recliner-7', 'product-roma-recliner-8'],
    ...
    details: [
      'Upholstered in 100% top-grain Italian leather',
      'Whisper-quiet power reclining mechanism',
      'High-density foam core with a plush fiber wrap',
      'Sturdy frame with a combination of solid wood and steel',
      '3-Seater Seat Depth: 52cm to 66cm',
      '2-Seater Seat Depth: 66cm',
      'Corner Sofa Seat Depth: 52cm'
    ],
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 68,
    imageIds: ['product-shannon-sofa-1', 'product-shannon-sofa-2', 'product-shannon-sofa-3', 'product-shannon-sofa-4', 'product-shannon-sofa-5', 'product-shannon-sofa-6'],
  ...
  },
  {
    ...
    variants: [
      ...
      { size: '3 Seater', price: 399.00, dimensions: { width: '202cm', height: '90cm', depth: '90cm' } },
      { size: '3+2 Seater', price: 670.00 },
      { size: '5 Seater Corner', price: 690.00 },
    ],
    rating: 4.8,
    reviewCount: 58,
    imageIds: ['product-sorrento-recliner-1', 'product-sorrento-recliner-2', 'product-sorrento-recliner-3', 'product-sorrento-recliner-4', 'product-sorrento-recliner-5'],
  ...
  },
  {
    ...
    variants: [
      ...
      { size: '3 Seater', price: 350.00, dimensions: { width: '200cm', height: '95cm', depth: '95cm' } },
      { size: 'Corner Sofa', price: 490.00, dimensions: { width: '230cm', height: '95cm', depth: '230cm' } },
    ],
    rating: 4.7,
    reviewCount: 62,
    imageIds: ['product-verona-sofa-1', 'product-verona-sofa-2', 'product-verona-sofa-3', 'product-verona-sofa-5', 'product-verona-sofa-6', 'product-verona-sofa-7', 'product-verona-sofa-9', 'product-verona-sofa-11', 'product-verona-sofa-12'],
    ...
    details: [
      ...
      'Upholstered in a premium, soft-touch woven fabric',
      'Solid wood frame for lasting stability',
      'Footstool: 75cm x 55cm'
    ],
  ...
  },
  {
    ...
    color: 'Silver',
    colors: [
      { name: 'Persian Plum', hex: '#641c24' },
      { name: 'Pesto', hex: '#886c29' },
      { name: 'Cadet', hex: '#3c7a6c' },
      { name: 'Silver Chalice', hex: '#b1a89e' },
      { name: 'Grey Cloud', hex: '#bcb4af' },
      { name: 'Heavy Metal', hex: '#2e2c2a' },
      { name: 'Mineral Green', hex: '#426663' },
      { name: 'Grey', hex: '#808080' },
      { name: 'Bluish Grey', hex: '#7690a0' },
      { name: 'Silver', hex: '#ded7d2' },
    ],
    variants: [
    ...
    rating: 5,
    reviewCount: 45,
    imageIds: ['product-bed-ambassador-1', 'product-bed-ambassador-2', 'product-bed-ambassador-3', 'product-bed-ambassador-4', 'product-bed-ambassador-5', 'product-bed-ambassador-6', 'product-bed-ambassador-7', 'product-bed-ambassador-8', 'product-bed-ambassador-9', 'product-bed-ambassador-10'],
  ...
  },
  {
    ...
    colors: [
      { name: 'Silver Chalice', hex: '#b1a89e' },
      { name: 'Turkish Rose', hex: '#aa7285' },
      { name: 'Heavy Metal', hex: '#2e2c2a' },
      { name: 'Silver', hex: '#C0C0C0' },
      { name: 'Grey', hex: '#808080' },
      { name: 'Blue Bayoux', hex: '#3b5d78' },
      { name: 'Cadet', hex: '#436e69' },
      { name: 'Slate', hex: '#4f6277' },
      { name: 'Mulled Wine', hex: '#645e74' },
    ],
    variants: [
    ...
    rating: 4.8,
    reviewCount: 68,
    imageIds: ['product-bed-sleigh-1', 'product-bed-sleigh-2', 'product-bed-sleigh-3', 'product-bed-sleigh-4', 'product-bed-sleigh-5', 'product-bed-sleigh-6', 'product-bed-sleigh-7', 'product-bed-sleigh-8', 'product-bed-sleigh-9', 'product-bed-sleigh-10', 'product-bed-sleigh-11'],
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 78,
    imageIds: ['product-bed-divan-1', 'product-bed-divan-2', 'product-bed-divan-3', 'product-bed-divan-4', 'product-bed-divan-5', 'product-bed-divan-6', 'product-bed-divan-7', 'product-bed-divan-8', 'product-bed-divan-9', 'product-bed-divan-10', 'product-bed-divan-11'],
  ...
  },
  {
    ...
    color: 'Silver',
    colors: [
      { name: 'Nile Blue', hex: '#1b3357' },
      { name: 'Dark Teal', hex: '#054c54' },
      { name: 'Grey', hex: '#808080' },
      { name: 'Silver Pink', hex: '#d5bdb1' },
      { name: 'Turkish Rose', hex: '#d5aaa0' },
      { name: 'Heavy Metal', hex: '#2e2c2a' },
    ],
    variants: [
    ...
    rating: 4.9,
    reviewCount: 55,
    imageIds: ['product-bed-mirror-1', 'product-bed-mirror-2', 'product-bed-mirror-3', 'product-bed-mirror-4', 'product-bed-mirror-5', 'product-bed-mirror-6', 'product-bed-mirror-7', 'product-bed-mirror-8', 'product-bed-mirror-9', 'product-bed-mirror-10', 'product-bed-mirror-11'],
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 40,
    imageIds: ['product-bed-panel-ambassador-1', 'product-bed-panel-ambassador-2', 'product-bed-panel-ambassador-3', 'product-bed-panel-ambassador-4'],
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 35,
    imageIds: ['product-bed-panel-bumper-1', 'product-bed-panel-bumper-2', 'product-bed-panel-bumper-3', 'product-bed-panel-bumper-4'],
  ...
  },
  {
    ...
    color: 'Blue',
    colors: [
      { name: 'Heavy Metal', hex: '#2b2b2b' },
      { name: 'Pesto', hex: '#c19b47' },
      { name: 'Pinkish Red', hex: '#e0a9b9' },
      { name: 'Cadet', hex: '#25675d' },
      { name: 'Blue', hex: '#04417e' },
      { name: 'Bluish Grey', hex: '#7690a0' },
      { name: 'Silver', hex: '#ded7d2' },
      { name: 'Persian Plum', hex: '#4c272a' },
      { name: 'Grey', hex: '#808080' },
    ],
    variants: [
    ...
    rating: 4.8,
    reviewCount: 38,
    imageIds: ['product-bed-panel-line-1', 'product-bed-panel-line-2', 'product-bed-panel-line-3', 'product-bed-panel-line-4', 'product-bed-panel-line-5', 'product-bed-panel-line-6', 'product-bed-panel-line-7', 'product-bed-panel-line-8', 'product-bed-panel-line-9', 'product-bed-panel-line-10'],
  ...
  },
  {
    ...
    colors: [
      { name: 'Silver Chalice', hex: '#b1a89e' },
      { name: 'Silver', hex: '#C0C0C0' },
      { name: 'Blue Bayoux', hex: '#004277' },
      { name: 'Coffee', hex: '#9f864c' },
      { name: 'Grey', hex: '#999893' },
      { name: 'Dark Grey', hex: '#808080' },
      { name: 'Grey Cloud', hex: '#bcb4af' },
      { name: 'Heavy Metal', hex: '#2e2c2a' },
    ],
    variants: [
    ...
    rating: 4.9,
    reviewCount: 42,
    imageIds: ['product-bed-panel-wing-back-1', 'product-bed-panel-wing-back-2', 'product-bed-panel-wing-back-3', 'product-bed-panel-wing-back-4', 'product-bed-panel-wing-back-5', 'product-bed-panel-wing-back-6', 'product-bed-panel-wing-back-7', 'product-bed-panel-wing-back-8', 'product-bed-panel-wing-back-9', 'product-bed-panel-wing-back-10', 'product-bed-panel-wing-back-11', 'product-bed-panel-wing-back-12'],
...
export const reviews: Review[] = [
  { id: '1', productId: '1', author: 'Jane D.', rating: 5, title: 'Absolutely stunning!', comment: 'The sofa is even more beautiful in person. It\'s comfortable, stylish, and was delivered right on time. Highly recommend!', date: '2023-08-15', tags: ['comfort', 'delivery'], upvotes: 15, downvotes: 1 },
  { id: '2', productId: '1', author: 'Mark S.', rating: 4, title: 'Great sofa, minor issue', comment: 'Love the look and feel. One of the legs was slightly scratched on arrival, but customer service was fantastic and sent a replacement immediately.', date: '2023-08-20', tags: ['delivery'], upvotes: 8, downvotes: 0 },
  { id: '3', productId: '2', author: 'Emily R.', rating: 5, title: 'Perfect dining table', comment: 'This table is the heart of our home now. The quality of the oak is outstanding. We\'ve had so many compliments!', date: '2023-07-05', tags: ['quality'], upvotes: 22, downvotes: 0 },
  { id: '4', productId: '3', author: 'Sarah K.', rating: 5, title: 'Bedroom transformed!', comment: 'The Cloud Nine bed is a dream. It was easy to assemble and has completely transformed our bedroom into a luxury retreat.', date: '2023-09-01', tags: ['assembly', 'comfort'], upvotes: 18, downvotes: 0 },
  { id: '5', productId: '4', author: 'Tom B.', rating: 4.5, title: 'Stylish and comfortable', comment: 'This armchair is the perfect reading chair. It\'s firm but comfortable and looks incredibly stylish in my living room.', date: '2023-09-10', tags: ['comfort'], upvotes: 12, downvotes: 2 },
  { id: '6', productId: '1', author: 'Chris P.', rating: 4, title: 'Solid and stylish', comment: 'A really great sofa for the price. It is firm, which I like. The color is slightly different than online but it still works.', date: '2023-09-15', tags: ['quality'], upvotes: 10, downvotes: 1 },
  { id: '7', productId: '1', author: 'Jessica L.', rating: 5, title: 'My dream sofa!', comment: 'I am so in love with this sofa. It is the perfect size for my apartment and so comfortable. Assembly was surprisingly easy.', date: '2023-10-02', tags: ['comfort', 'assembly'], upvotes: 25, downvotes: 0 },
  { id: '8', productId: '2', author: 'David H.', rating: 5, title: 'Outstanding Quality', comment: 'Solid wood, beautifully finished. You can tell this table is built to last. Worth every penny.', date: '2023-09-22', tags: ['quality'], upvotes: 30, downvotes: 0 },
  { id: '9', productId: '2', author: 'Laura C.', rating: 4, title: 'Beautiful but heavy!', comment: 'It\'s a gorgeous table, but be prepared, it is extremely heavy! You will need two people to assemble it.', date: '2023-10-11', tags: ['assembly'], upvotes: 5, downvotes: 0 },
  { id: '10', productId: '3', author: 'Michael B.', rating: 5, title: 'Sleeps like a baby', comment: 'I was hesitant to buy a bed online but this was a great decision. The headboard is so soft and it feels very sturdy.', date: '2023-09-05', tags: ['comfort', 'quality'], upvotes: 14, downvotes: 0 },
  { id: '11', productId: '4', author: 'Olivia W.', rating: 5, title: 'The perfect accent chair', comment: 'This chair completed my living room. The leather is high quality and the wood has a beautiful grain. It\'s a work of art.', date: '2023-10-18', tags: ['quality'], upvotes: 9, downvotes: 0 },
  { id: '12', productId: '5', author: 'Ben A.', rating: 5, title: 'Makes me want to work', comment: 'This desk is incredible. The walnut is beautiful and it has so much space. My home office finally feels complete.', date: '2023-09-28', tags: ['quality'], upvotes: 7, downvotes: 0 },
  { id: '13', productId: '5', author: 'Chloe G.', rating: 4, title: 'Great desk, drawers a bit small', comment: 'I love the look and feel of the desk. The surface is huge. I just wish the drawers were a little deeper, but it\'s a minor complaint.', date: '2023-10-08', upvotes: 3, downvotes: 1 },
  { id: '14', productId: '6', author: 'Liam T.', rating: 5, title: 'Perfect for my apartment', comment: 'Fits perfectly in my small living room and holds a surprising number of books. It was also very easy to put together by myself.', date: '2023-10-14', tags: ['assembly'], upvotes: 11, downvotes: 0 },
  { id: '15', productId: '6', author: 'Sophia N.', rating: 3, title: 'Looks good, but feels a bit wobbly', comment: 'The shelf looks great, but it doesn\'t feel as sturdy as I\'d hoped. Definitely need to use the wall anchors it came with.', date: '2023-10-20', tags: ['assembly', 'quality'], upvotes: 2, downvotes: 3 },
  { id: '16', productId: '7', author: 'Daniel R.', rating: 5, title: 'Elegant and functional', comment: 'This lamp is a showstopper. It provides great light for reading on the sofa and the marble base is very heavy and stable.', date: '2023-09-30', tags: ['quality'], upvotes: 6, downvotes: 0 },
  { id: '17', productId: '7', author: 'Grace P.', rating: 4, title: 'Love it, but tricky to position', comment: 'A beautiful lamp. The arc is quite large, so make sure you have enough space for it. It took a few tries to get it in the perfect spot.', date: '2023-10-05', upvotes: 1, downvotes: 0 },
  { id: '18', productId: '8', author: 'Ethan K.', rating: 5, title: 'So soft and beautiful', comment: 'The rug feels amazing underfoot. The pattern is subtle but adds so much character to the room. It unrolled flat almost immediately.', date: '2023-09-18', tags: ['comfort'], upvotes: 13, downvotes: 0 },
  { id: '19', productId: '8', author: 'Mia V.', rating: 5, title: 'Completes the room!', comment: 'This rug was the final piece my living room needed. The quality is excellent and the colors are true to the photos online.', date: '2023-10-25', tags: ['quality'], upvotes: 4, downvotes: 0 },
  { id: '20', productId: '4', author: 'Noah F.', rating: 5, title: 'My new favorite spot', comment: 'I find myself sitting in this chair all the time. It looks great and is surprisingly comfortable for long periods. A fantastic purchase.', date: '2023-10-28', tags: ['comfort'], upvotes: 9, downvotes: 1 },
  { id: '21', productId: '11', author: 'Olivia M.', rating: 5, title: 'Absolutely Regal!', comment: 'This bed is a statement piece. The headboard is massive and so luxurious. It feels like sleeping in a 5-star hotel every night. Worth every penny!', date: '2023-10-15', tags: ['comfort', 'quality'], upvotes: 40, downvotes: 2 },
  { id: '22', productId: '11', author: 'Liam B.', rating: 5, title: 'Incredible build quality', comment: 'You can feel how sturdy this bed is. The crushed velvet is incredibly soft and the colour is beautiful. The delivery team was also very professional.', date: '2023-10-20', tags: ['quality', 'delivery'], upvotes: 35, downvotes: 0 },
  { id: '23', productId: '11', author: 'Sophia T.', rating: 4, title: 'Stunning but HUGE!', comment: 'I am in love with this bed, it is absolutely stunning. Just a word of warning - make sure you measure your space! The headboard is very tall but it looks amazing.', date: '2023-10-28', tags: ['assembly'], upvotes: 15, downvotes: 1 },
  { id: '24', productId: '12', author: 'James P.', rating: 5, title: 'Classic and Comfortable', comment: 'This sleigh bed is perfect. It has a timeless look and it\'s incredibly comfortable. Assembly was straightforward and it feels very solid.', date: '2023-11-01', tags: ['comfort', 'assembly', 'quality'], upvotes: 28, downvotes: 0 },
  { id: '25', productId: '12', author: 'Charlotte H.', rating: 4, title: 'Great value and looks expensive', comment: 'I\'m so pleased with this purchase. It looks much more expensive than it was. The fabric is soft and the button tufting is well done. A fantastic bed for the price.', date: '2023-10-25', upvotes: 22, downvotes: 2 },
  { id: '26', productId: '12', author: 'Amelia W.', rating: 5, title: 'Beautiful and elegant', comment: 'The bed is beautiful, and the curved headboard adds a really elegant touch to my bedroom. I opted for the mattress bundle and it\'s very comfortable.', date: '2023-11-05', tags: ['comfort'], upvotes: 19, downvotes: 0 },
  { id: '27', productId: '12', author: 'Noah F.', rating: 5, title: 'Fantastic Sleigh Bed', comment: 'I love the classic design of this bed. It was delivered quickly and was easy to assemble. The quality is great for the price.', date: '2023-11-08', tags: ['delivery', 'assembly', 'quality'], upvotes: 25, downvotes: 1 },
  { id: '28', productId: '12', author: 'Ava J.', rating: 4.5, title: 'So cozy!', comment: 'This bed makes my room feel so cozy and romantic. The headboard is perfect for reading in bed. Highly recommended.', date: '2023-11-10', tags: ['comfort'], upvotes: 18, downvotes: 0 },
  { id: '29', productId: '12', author: 'Oliver T.', rating: 5, title: 'Great purchase!', comment: 'Really happy with this bed. It feels sturdy and looks fantastic. The delivery process was smooth and the communication was great.', date: '2023-11-12', tags: ['delivery', 'quality'], upvotes: 20, downvotes: 0 },
  { id: '30', productId: '12', author: 'Isabella C.', rating: 5, title: 'A dream come true!', comment: 'I have always wanted a sleigh bed and this one is perfect. The quality is amazing and it looks so grand in my room. Five stars!', date: '2023-11-15', tags: ['quality'], upvotes: 30, downvotes: 0 },
  { id: '31', productId: '12', author: 'George K.', rating: 4, title: 'Lovely bed', comment: 'A lovely bed, very well made. It was a bit tricky to get up the stairs as the headboard is large, so keep that in mind. But once assembled, it\'s fantastic.', date: '2023-11-18', tags: ['assembly'], upvotes: 12, downvotes: 2 },
  { id: '32', productId: '12', author: 'Hannah L.', rating: 5, title: 'So luxurious', comment: 'The fabric is so soft and the bed feels incredibly luxurious. I\'m so happy with my purchase. It has completely changed the feel of my bedroom.', date: '2023-11-20', tags: ['comfort'], upvotes: 24, downvotes: 1 },
  { id: '33', productId: '12', author: 'Ava J.', rating: 5, title: 'Simply Stunning', comment: 'I am so impressed with this bed. The quality is exceptional and it looks so grand in our master bedroom. It has exceeded all my expectations. The delivery was also quick and the setup was easy. Highly recommend it to anyone looking for a statement piece.', date: '2023-11-21', tags: ['quality', 'delivery', 'assembly'], upvotes: 45, downvotes: 0 },
  { id: '34', productId: '12', author: 'William D.', rating: 4, title: 'Great Bed, Great Price', comment: 'For the price, you cannot beat the quality of this bed. It feels very solid and the upholstery is well done. It was a bit of a challenge to assemble on my own, but I managed it. Overall, a fantastic buy.', date: '2023-11-22', tags: ['assembly', 'quality'], upvotes: 33, downvotes: 3 },
  { id: '35', productId: '12', author: 'Mia L.', rating: 5, title: 'Elegant and Timeless', comment: 'This sleigh bed is a timeless piece. It brings a touch of elegance to my bedroom without being overly ornate. The fabric is a beautiful neutral grey that goes with everything. I\'m thrilled with this purchase.', date: '2023-11-24', upvotes: 28, downvotes: 1 },
];
