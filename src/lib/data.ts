...
export const products: Product[] = [
  ...
  },
  {
    ...
    color: 'Silver',
    colors: [
      { name: 'Plum', hex: '#5B162Eff' },
      { name: 'Gold', hex: '#a8804f' },
      { name: 'Dark Green', hex: '#243f36ff' },
      { name: 'Silver', hex: '#7a7d84' },
      { name: 'Cream', hex: '#B5AC9Cff' },
      { name: 'Black', hex: '#030303' },
      { name: 'Teal', hex: '#305d70' },
      { name: 'Grey', hex: '#5f6261' },
      { name: 'Duck Egg', hex: '#7EBED7ff' },
    ],
    variants: [
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Silver', hex: '#7a7d84' },
      { name: 'Grey', hex: '#5f6261' },
      { name: 'Blue', hex: '#0B335Bff' },
      { name: 'Dark Green', hex: '#243f36ff' },
      { name: 'Purple', hex: '#533563ff' },
    ],
    variants: [
