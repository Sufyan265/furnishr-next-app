...
export const products: Product[] = [
  ...
  {
    id: '9',
    slug: 'rustic-charm-bed-frame',
    name: 'Rustic Charm Bed Frame',
    category: 'Beds',
    categorySlug: 'beds',
    price: 890.00,
    rating: 4.7,
    reviewCount: 130,
    imageIds: productImagesMap['rustic-charm-bed'].map(i => i.id),
    description: 'Bring a touch of countryside charm to your bedroom with this solid reclaimed pine bed frame. Its robust construction and natural finish create a cozy, inviting atmosphere.',
    details: ['Made from 100% reclaimed pine', 'Sturdy slat system supports any mattress', 'Natural wood grain and knot variations', 'Easy to assemble'],
    dimensions: { width: '155cm', height: '120cm', depth: '205cm' },
    style: 'Rustic',
    material: 'Pine',
    stock: 18,
  },
