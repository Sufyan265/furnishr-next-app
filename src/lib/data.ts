...
export const socialProofData = {
  names: ["John", "Emily", "Michael", "Sarah", "David", "Jessica", "Chris", "Laura", "James", "Olivia"],
  locations: ["London", "Manchester", "Birmingham", "Glasgow", "Bristol", "Liverpool", "Edinburgh", "Leeds", "Cardiff", "Belfast"],
